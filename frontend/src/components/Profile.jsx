    ...
    <div className=" min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="flex items-center gap-4 mb-8">
          <div className="w-16 h-16 rounded-full bg-amber-500 flex items-center justify-center text-white text-2xl font-bold shadow-md">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <section className={SECTION_WRAPPER}>
            <div className="flex items-center gap-2 mb-6">
              <UserCircle className="text-amber-500 w-5 h-5" />
          ...
          <section className={SECTION_WRAPPER}>
            ...
            <form onSubmit={changePassword} className="space-y-4">
              {securityFields.map(({ name, placeholder }) => (
                <div key={name} className={INPUT_WRAPPER}>
                  <Lock className="text-amber-500 w-5 h-5 mr-2" />
                  <input
                    type="password"
                    placeholder={placeholder}
