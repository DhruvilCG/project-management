  ...
  const fetchTasks = useCallback(async () => {
    ...
    try {
      ...
      const { data } = await axios.get(
        "https://project-management-backend-1-qk79.onrender.com/api/tasks/gp",
        {
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="xl:col-span-1 space-y-4 sm:space-y-6">
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-amber-100">
              ...
              <hr className="my-3 sm:my-4 border-amber-100" />
            ...
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-amber-100">
                ...
                <div className="space-y-2 sm:space-y-3">
                    {tasks.slice(0,3).map((task)=>{
                        <div key={task._id || task.id} className="flex items-center justify-between p-2 sm:p-3 hover:bg-amber-50/50 rounded-lg transition-colors duration-200 border border-transparent hover:border-amber-100">
                            ...
                            <span className={`px-2 py-1 text-xs rounded-full shrink-0 ml-2 ${task.completed ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700'}`}>
