...
export const CT_CLASSES = {
    ...
    sortBox: "flex items-center justify-between bg-white p-2 md:p-3 rounded-xl shadow-sm border border-amber-100 w-full md:w-auto",
    filterLabel: "flex items-center gap-2 text-gray-700 font-medium",
    select: "px-2 py-1 md:px-3 md:py-2 border border-amber-100 rounded-lg focus:ring-2 focus:ring-amber-500 md:hidden text-xs md:text-sm",
    btnGroup: "hidden md:flex space-x-1 bg-amber-50 p-1 rounded-lg ml-2 md:ml-3",
    btnBase: "px-2 py-1 md:px-3 md:py-1.5 rounded-lg text-xs font-medium transition-all duration-200 flex items-center gap-1",
    btnActive: "bg-white text-amber-700 shadow-sm border border-amber-100",
    btnInactive: "text-gray-600 hover:text-amber-700 hover:bg-amber-100/50",
    list: "space-y-3 md:space-y-4",
    emptyState: "p-4 md:p-8 bg-white rounded-xl shadow-sm border border-amber-100 text-center",
    emptyIconWrapper: "w-12 h-12 md:w-16 md:h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4",
