  ...
  return (
    <div className={WRAPPER}>
      ...
      <div className="space-y-6">
        ...
        <div
          onClick={() => setShowModal(true)}
          className="hidden md:flex items-center justify-center p-4 border-2 border-dashed border-amber-200 rounded-xl hover:border-amber-400 bg-amber-50/50 cursor-pointer transition-colors"
        >
